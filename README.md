...
You can downlaod the newest Version from github [releases](https://github.com/theLeroy/TailwindExportPlugin/releases) and install by opening the .XDX File.


## How to use

After the installation you will get an action with the name 'Export global Typo and Color'. This Action can be found either under 'plugins > TailwindExport' or in the plugin tab.
